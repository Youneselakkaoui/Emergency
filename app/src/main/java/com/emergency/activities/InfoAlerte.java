 ...
 */
public class InfoAlerte extends Fragment implements OnClickListener   {
    ...
    public void onClick(View view){
        ...
        GoogleMapActivity secondFragment = (GoogleMapActivity) InfoAlerte.this.getActivity()
                .getFragmentManager().findFragmentById(R.id.map);
        secondFragment.getView().setVisibility(View.VISIBLE);
        InfoAlerte.this.getView().setVisibility(View.GONE);
